...
Widget buildGtToastUsecase(BuildContext context) {
  ...
  return GtWidgetDocPage(
    title: "GtToast Playground",
    description: "Documentation for GtToast",
...
Widget buildGtAlertUsecase(BuildContext context) {
  ...
  return GtWidgetDocPage(
    title: "GtAlert Playground",
    description: "Documentation for GtAlert",
    child: GtRaisedButton(
      onPressed: () {
        context.showAlert(
          title,
...
Widget buildGtToolTipUsecase(BuildContext context) {
  return GtWidgetDocPage(
    title: "GtTooltip Playground",
    description: "Documentation for GtTooltip",
    child: Builder(
      builder: (context) {
        return Column(
