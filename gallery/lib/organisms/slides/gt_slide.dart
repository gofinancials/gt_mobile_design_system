...
Widget buildGtSectionSlideUsecase(BuildContext context) {
  ...
  final featured = [
    ...
    GtLessonCard(
      ...
      totalLessons: 8,
      duration: 4.minutes,
      illustration: AppImageData.asset(GtVectorIllustrations.moneyPhone),
      variant: .verified,
      onTap: showToast,
    ),
    GtLessonCard(
      ...
      totalLessons: 15,
      duration: 20.minutes,
      illustration: AppImageData.asset(GtVectorIllustrations.fuel),
      variant: .normal,
      onTap: showToast,
    ),
  ];
  final completed = [
    GtLessonCard(
      ...
      illustration: AppImageData.asset(GtVectorIllustrations.security),
      variant: .warning,
      onTap: showToast,
    ),
  ];
