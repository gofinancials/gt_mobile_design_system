...
Widget buildGtTextFieldUsecase(BuildContext context) {
  return const _GtFormExample();
}

class _GtFormExample extends GtStatefulWidget {
  const _GtFormExample();

  @override
  State<_GtFormExample> createState() => _GtFormExampleState();
}

class _GtFormExampleState extends State<_GtFormExample> {
  ...
  final _fxNote = GtInputController();
  ...
  void dispose() {
    ...
    _inputCtrl8.dispose();
    _inputCtrl9.dispose();
    _inputCtrl10.dispose();
    _inputCtrl11.dispose();
    _inputCtrl12.dispose();
    _inputCtrl13.dispose();
    _inputCtrl14.dispose();
    _inputCtrl15.dispose();
    _inputCtrl16.dispose();
    _fxSource.dispose();
    _fxTarget.dispose();
    _fxNote.dispose();
    super.dispose();
