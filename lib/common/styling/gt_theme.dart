...
class GtTheme {
  ...
  ThemeData get materialDark {
    ...
    return base.copyWith(
      primaryTextTheme: base.primaryTextTheme.apply(fontFamily: fonts.body),
      primaryColorLight: darkPalette.primary.dark,
      primaryColorDark: darkPalette.primary.dark,
      canvasColor: darkPalette.bg.white,
      ...
      hintColor: darkPalette.text.sub,
      highlightColor: darkPalette.primary.alpha10,
      focusColor: darkPalette.primary.alpha10,
      hoverColor: darkPalette.primary.alpha10,
      unselectedWidgetColor: darkPalette.icon.sub,
      secondaryHeaderColor: darkPalette.bg.sub,
      ...
      colorScheme: base.colorScheme.copyWith(
        ...
        primary: darkPalette.primary.dark,
        shadow: darkPalette.bg.strong.setOpacity(.17),
        surfaceTint: darkPalette.primary.alpha16,
        brightness: Brightness.dark,
        onPrimary: darkPalette.staticColors.white,
        primaryContainer: darkPalette.primary.alpha16,
        onPrimaryContainer: darkPalette.primary.darker,
        onError: darkPalette.staticColors.white,
        errorContainer: darkPalette.error.light,
        onErrorContainer: darkPalette.error.darker,
        onSurface: darkPalette.text.strong,
        onSurfaceVariant: darkPalette.text.sub,
        outline: darkPalette.stroke.strong,
        outlineVariant: darkPalette.stroke.soft,
        secondary: darkPalette.primary.dark,
        onSecondary: darkPalette.staticColors.white,
        secondaryContainer: darkPalette.primary.alpha16,
        onSecondaryContainer: darkPalette.primary.darker,
        tertiary: darkPalette.primary.dark,
        onTertiary: darkPalette.staticColors.white,
        tertiaryContainer: darkPalette.primary.alpha16,
        onTertiaryContainer: darkPalette.primary.darker,
        surfaceBright: darkPalette.bg.white,
        surfaceDim: darkPalette.bg.sub,
        surfaceContainerHighest: darkPalette.bg.sub,
        surfaceContainerHigh: darkPalette.bg.sub,
        surfaceContainer: darkPalette.bg.white,
        surfaceContainerLow: darkPalette.bg.white,
        surfaceContainerLowest: darkPalette.bg.white,
        inversePrimary: darkPalette.primary.alpha16,
        inverseSurface: darkPalette.text.strong,
        onInverseSurface: darkPalette.bg.white,
      ),
  ...
  ThemeData get materialLight {
    ...
    return base.copyWith(
      primaryTextTheme: base.primaryTextTheme.apply(fontFamily: fonts.body),
      primaryColorLight: lightPalette.primary.dark,
      primaryColorDark: lightPalette.primary.dark,
      canvasColor: lightPalette.bg.white,
      ...
      hintColor: lightPalette.text.sub,
      highlightColor: lightPalette.primary.alpha10,
      focusColor: lightPalette.primary.alpha10,
      hoverColor: lightPalette.primary.alpha10,
      unselectedWidgetColor: lightPalette.icon.sub,
      secondaryHeaderColor: lightPalette.bg.sub,
      dialogTheme: base.dialogTheme.copyWith(
      ...
      colorScheme: base.colorScheme.copyWith(
        ...
        shadow: lightPalette.bg.strong.setOpacity(.17),
        surfaceTint: lightPalette.primary.alpha16,
        brightness: Brightness.light,
        onPrimary: lightPalette.staticColors.white,
        primaryContainer: lightPalette.primary.alpha16,
        onPrimaryContainer: lightPalette.primary.darker,
        onError: lightPalette.staticColors.white,
        errorContainer: lightPalette.error.light,
        onErrorContainer: lightPalette.error.darker,
        onSurface: lightPalette.text.strong,
        onSurfaceVariant: lightPalette.text.sub,
        outline: lightPalette.stroke.strong,
        outlineVariant: lightPalette.stroke.soft,
        secondary: lightPalette.primary.dark,
        onSecondary: lightPalette.staticColors.white,
        secondaryContainer: lightPalette.primary.alpha16,
        onSecondaryContainer: lightPalette.primary.darker,
        tertiary: lightPalette.primary.dark,
        onTertiary: lightPalette.staticColors.white,
        tertiaryContainer: lightPalette.primary.alpha16,
        onTertiaryContainer: lightPalette.primary.darker,
        surfaceBright: lightPalette.bg.white,
        surfaceDim: lightPalette.bg.sub,
        surfaceContainerHighest: lightPalette.bg.sub,
        surfaceContainerHigh: lightPalette.bg.sub,
        surfaceContainer: lightPalette.bg.white,
        surfaceContainerLow: lightPalette.bg.white,
        surfaceContainerLowest: lightPalette.bg.white,
        inversePrimary: lightPalette.primary.alpha16,
        inverseSurface: lightPalette.text.strong,
        onInverseSurface: lightPalette.bg.white,
      ),
