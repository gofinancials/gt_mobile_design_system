/// A utility class that holds the paths to all vector icons (SVGs) used in the application.
///
...
class GtVectorIcons {
  ...
  /// Path to the help info icon SVG.
